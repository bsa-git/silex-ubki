...
//    private $_http_codes = NULL;
    ...
    function post($url, array $options = array()) {
        ...
        $defaults = array(
            ...
            CURLOPT_CONNECTTIMEOUT => 120,//$timeout_on_connect, // timeout on connect 
            CURLOPT_TIMEOUT => 120,//$timeout_on_response, // timeout on response 
            CURLOPT_MAXREDIRS => 10, // stop after 10 redirects 
            CURLOPT_POST => 1, // i am sending post data 
            CURLOPT_POSTFIELDS => $data, // this are my post vars 
            CURLOPT_SSL_VERIFYHOST => false, // don't verify ssl 
            CURLOPT_SSL_VERIFYPEER => false, // 
            CURLOPT_VERBOSE => false,// TRUE To display more information.
